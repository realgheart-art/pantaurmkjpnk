...
2. Muat naik `index.html` ke repo (drag & drop pada halaman repo → Commit).
...
6. Buka pautan tu — skrin log masuk akan muncul. Masuk dengan akaun admin.

> Setiap kali ubah `index.html`, muat naik semula fail ke repo. Pages akan kemas kini sendiri dalam seminit dua.

## Langkah 8 — Semakan akhir
